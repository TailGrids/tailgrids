...
const calendarCellButtonStyles = cva(
  "flex size-10 items-center justify-center rounded-full text-sm font-medium text-title-50 outline-none transition forced-color-adjust-none [-webkit-tap-highlight-color:transparent] hover:bg-datepicker-selected-hover-background data-[outside-month=true]:pointer-events-none data-[outside-month=true]:text-text-200 data-[disabled=true]:cursor-not-allowed group-[&[data-disabled=true]:not([data-outside-month]):not([data-today])]:text-text-100 group-data-[unavailable=true]:text-text-100 group-data-[today=true]:bg-datepicker-selected-background/90 group-data-[today=true]:text-white data-[selected=true]:bg-datepicker-selected-background data-[selected=true]:text-white-100 data-[pressed=true]:scale-95 data-[focus-visible=true]:ring-2 data-[focus-visible=true]:ring-button-primary-focus-ring data-[focus-visible=true]:ring-offset-2 data-[focus-visible=true]:ring-offset-background-50 sm:size-11 [&[data-disabled=true]:not([data-outside-month])]:line-through group-data-[today=true]:hover:bg-datepicker-selected-background/90"
);
