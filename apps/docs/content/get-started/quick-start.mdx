...
Copy the contents of the generated `tailgrids.css` file and paste them into your main CSS file (e.g., `globals.css` or `app.css`). See [Global CSS Variables](/get-started/global-variables) page for the default styles.
