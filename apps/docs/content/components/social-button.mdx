...
import SocialButtonBrandsPreview from "@/components/preview/social-button/social-button-brands-preview";
...
import SocialButtonFilledPreview from "@/components/preview/social-button/social-button-filled-preview";
import SocialButtonPreview from "@/components/preview/social-button/social-button-preview";
import SocialButtonShadowPreview from "@/components/preview/social-button/social-button-shadow-preview";
...
Standard outline social buttons with various brand icons.

<ComponentPreview
  codeSnippet={getFileContent(
    "/src/components/preview/social-button/social-button-brands-preview.tsx"
  )}
>
  <SocialButtonBrandsPreview />
</ComponentPreview>

### Filled

Social buttons with a subtle background and border.

<ComponentPreview
  codeSnippet={getFileContent(
    "/src/components/preview/social-button/social-button-filled-preview.tsx"
  )}
>
  <SocialButtonFilledPreview />
</ComponentPreview>
...
<ComponentPreview
  codeSnippet={getFileContent(
    "/src/components/preview/social-button/social-button-shadow-preview.tsx"
  )}
>
  <SocialButtonShadowPreview />
</ComponentPreview>
