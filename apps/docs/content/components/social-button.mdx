...
<CodeBlockCard
  ...
  lang="tsx"
  fileName="components/ui/social-button.tsx"
/>
...
Create compact social actions using icon-only buttons for a minimalist authentication or sharing experience.
...
Indicate unavailable authentication methods and prevent clicks by applying the `disabled` prop to your social buttons.
