...
The Overlay component relies on the `react-aria-components` library. Install the required dependencies:
...
<CodeBlockCard
  snippet={getFileContent("/src/registry/core/overlay.tsx")}
  lang="tsx"
