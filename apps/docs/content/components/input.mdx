...
Built with React Aria Components and styled using Tailwind CSS. It is designed to be used with the [Label component](https://tailgrids.com/docs/components/label) for accessibility and supports validation states, as well as controlled and uncontrolled inputs.
