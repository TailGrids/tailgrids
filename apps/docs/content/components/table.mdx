...
A comprehensive user management table featuring checkboxes for selection, sorting indicators, status badges, and action buttons.

<ComponentPreview
  codeSnippet={getFileContent(
    "/src/components/preview/table/table-user-management-preview.tsx"
  )}
>
  <TableUserManagementPreview />
</ComponentPreview>
...
A specialized table for educational platforms showing course progress bars, instructor details, and certificate status.

<ComponentPreview
  codeSnippet={getFileContent(
    "/src/components/preview/table/table-course-progress-preview.tsx"
  )}
>
  <TableCourseProgressPreview />
</ComponentPreview>
