...
lang="tsx"
fileName="components/ui/text-area.tsx"
/>
</Accordion>
</Accordions>
...
Provide clear context and accessibility for longer text entries by using the `label` prop.
...
Display supportive helper text below the text area using the `hint` prop to guide users.
