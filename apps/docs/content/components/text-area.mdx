...
description: A React TextArea component for multi-line text input. Built on the React Aria textarea primitive with Tailgrids styling, validation states, controlled values, and accessible form handling.
---
