...
<CodeBlockCard
  ...
  lang="tsx"
  fileName="components/ui/dropdown.tsx"
/>
</Accordion>
</Accordions>
...
Organize menu items into logical groups using the `DropdownMenuSeparator` component for better visual hierarchy.
...
Group related actions under descriptive headers using the `DropdownMenuSection` and `DropdownMenuHeader` components.
